package com.macro.mall.search.index;


import java.util.HashMap;

import static com.macro.mall.search.constant.EsConstant.DATE_FORMAT;
import static com.macro.mall.search.constant.EsConstant.DATE_FORMAT_PATTERN;
...
public class MappingProperty extends HashMap<String, Object> {
    ...
    public MappingProperty(String type) {
        ...
        if (DATE.equals(type)) {
            ...
            this.put(SEARCH_ANALYZER, ANALYZER_IK_SMART);
        }
    }
